              ...
              <el-row :gutter="20">
                <el-col class="pl-0" :span="12">
                  <el-form-item
                    ...
                    label="项目名称:">
                    <el-input v-model="params.project.project_name" placeholder="【版本号简写】[需求号]需求名称"></el-input>
                  </el-form-item>
                </el-col>
                ...
                <template v-if="$api.user.getUsers.data.list.length>0">
                  ...
                  <el-form-item
                    ...
                    :label="groupName">
                      ...
                      <el-checkbox v-for="item in $api.user.getUsers.data.list.fileter(item=>item.group_name === groupName)" :label="item.id" :key="item.id">
                        <span>{{item.name}}</span>
